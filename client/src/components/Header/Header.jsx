            ...
            <img
              src={
                this.props.data.avatar === 'anon.png'
                  ...
                  : `${CONSTANTS.publicImgURL}${this.props.data.avatar}`
              }
              alt="user"
            />
      ...
      <div className={styles.headerContainer}>
        ...
        <div className={styles.loginSignnUpHeaders}>
          <div className={styles.numberContainer}>
            ...
            <a className={styles.phoneNumber} href="tel:+380955555244">+380955555244</a>
          </div>
        ...
        <div className={styles.navContainer}>
          ...
          <div className={styles.leftNav}>
            ...
            {this.props.data && this.props.data.role !== CONSTANTS.MODERATOR && this.props.data.role  !== CONSTANTS.CREATOR && (
              <div
